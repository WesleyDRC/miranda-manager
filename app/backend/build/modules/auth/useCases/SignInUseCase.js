    ...
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ email, password }) {
            ...
            if (foundUser.length <= 0) {
                throw new AppError_1.AppError(userConstants_1.userConstants.NOT_FOUND, 404);
            }
            const isCorrectPassword = yield this.encryptManager.compareHash(password, foundUser[0].password);
            if (!isCorrectPassword)
                throw new AppError_1.AppError(userConstants_1.userConstants.INCORRECT_PASSWORD, 401);
